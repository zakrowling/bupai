...
messageInput.addEventListener("input", () => {
  ...
  document.querySelector(".chat-form").style.borderRadius = messageInput.scrollHeight > initialInputHeight ? "4px" : "4px";
});
